...
`tspyro <https://github.com/awohns/tspyro>`_ is a software package for inferring the time and location of ancestral haplotypes in a `tree sequences <https://tskit.dev/tutorials/what_is.html>`_. The method is implemented with `Pyro <http://pyro.ai>`_ and variational inference.
