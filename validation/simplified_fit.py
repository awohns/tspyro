...
def fit_guide(
    ...
    heuristic_init_guess_loc = model.locations[model.unobserved]
    ...
    def init_loc_fn(site):
        ...
        if site["name"] == "internal_location":
            if init_loc is not None:
                ...
                initial_guess_loc = heuristic_init_guess_loc
    ...
    if Model.__name__ == 'NaiveModel':
        ...
        last_internal_log_time = unbound_guide.median()[key_name].log().clone()
    elif Model.__name__ == 'ConditionedTimesSimplifiedModel':
